            ...
            if($seatData == 0):?>
                ...
                <div style="border: 5px; margin-top: 5%; margin-left: 25%; center; background-color: #fef9fd; width: fit-content; padding: 10px">
                    ...
                    <form action="" method="post">
                        <input name="vId" type="text" style="padding: 2%; width:100%;margin-bottom: 2%;  background-color: #e7f2fa; border-radius: 10px"
                               placeholder="Varsity Id"><br>
                        <input name="section" type="text" style="padding: 2%; width:100%;margin-bottom: 2%;  background-color: #e7f2fa; border-radius: 10px"
                               placeholder="Section"><br>
                        <input name="department" type="text" style="padding: 2%; width:100%;margin-bottom: 2%;  background-color: #e7f2fa; border-radius: 10px"
                               placeholder="Department"><br>
                        <input name="advisor" type="text" style="padding: 2%; width:100%;margin-bottom: 2%;  background-color: #e7f2fa; border-radius: 10px"
                               placeholder="Advisor Name"><br>
                        <button type="submit" style="padding: 2%; width:100%;margin-bottom: 2%; color: white; font-weight: bold;  background-color: #b1cccc; border-radius: 10px">
                            Apply
                        </button>
                    </form>
                </div>
